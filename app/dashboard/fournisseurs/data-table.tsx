...
import { columns, FournisseurWithRelations } from "./columns";
...
export default function DataTables({ Element }: { Element: FournisseurWithRelations[] }) {
    ...
    const [data, setData] = useState<FournisseurWithRelations[]>([]);
    ...
    const handleDeleteRows = async () => {
        ...
        for (const idToDelete of idsToDelete) {
            await deleteFournisseur({ id: idToDelete });
        }
        ...
        <div className="space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button onClick={()=> router.push(`/dashboard/fournisseurs/create`) }>Nouveau Fournisseur</Button>
                    <ExportExcel
                      data={data}
                      filename="fournisseurs"
                      mapRow={(row: FournisseurWithRelations) => {
                        return {
                          Nom: row.nom,
                          Adresse: row.adresse || '',
