...
export default function DataTables({ Element }: { Element: ProspectWithRelations[] }) {
    const id = useId();
    ...
    const [data, setData] = useState<ProspectWithRelations[]>([]);
    useEffect(() => { setData(Element); }, [Element]);

    const filteredData = useMemo(() => {
        return data.filter((row) => {
            const okStage = selectedStage === "ALL" || row.stage === selectedStage;
            return okStage;
        });
    }, [data, selectedStage]);
                                ...
                                <div className="flex flex-col gap-2 max-sm:items-center sm:flex-row sm:gap-4">
                                    ...
                                    <AlertDialogHeader>
                                        ...
                                        <AlertDialogDescription>
                                            ...
                                            {table.getSelectedRowModel().rows.length} prospect{" "}
