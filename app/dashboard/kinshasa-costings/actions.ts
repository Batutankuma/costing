    ...
    try {
      const created = await prisma.kinshasaCosting.create({
        data: {
          ...
          currency: parsedInput.currency as any,
          ...
          cdfBreakdown: parsedInput.cdfBreakdown as any,
          usdBreakdown: parsedInput.usdBreakdown as any,
    ...
    try {
      ...
      const updated = await prisma.kinshasaCosting.update({
        ...
        data: {
          ...
          cdfBreakdown: data.cdfBreakdown as any,
          usdBreakdown: data.usdBreakdown as any,
