...
import { z } from "zod";
import { CreateTankSchema } from "@/models/mvc";
...
export default function CreateTankPage() {
  ...
  useEffect(() => {
    ...
    if (created === 'depot') {
      ...
      toast({ title: 'Succès', description: 'Dépôt créé. Vous pouvez maintenant créer un tank.' });
      // refresh depots
      (async () => {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold">Nouveau tank</h1>
          <p className="text-sm text-muted-foreground">
            Créez un nouveau tank pour stocker vos produits
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Informations du tank
          </CardTitle>
          <CardDescription>
            Remplissez les informations ci-dessous pour créer un nouveau tank
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-sm font-medium">
                Nom du tank <span className="text-destructive">*</span>
              </Label>
              <Input 
                id="name" 
                placeholder="Ex: Tank Principal, Tank de Réserve..." 
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value: string) => setValue("unit", value as TankFormData['unit'])}
                defaultValue="L"
              >
            ...
            <div className="flex gap-3 pt-4 border-t">
              ...
              >
                ...
                {submitting ? "Création..." : "Créer le tank"}
              </Button>
              <Button 
                type="button" 
                variant="outline" 
